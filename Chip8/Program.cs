...
namespace Chip8
{
    class Program
    {
        ...
        //            window = new GameWindow(display_width, display_height))
        ...
        //            // Update Texture
        //            GL.TexSubImage2D(TextureTarget2d.Texture2D, 0, 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, PixelFormat.Rgb, PixelType.UnsignedByte, screenData);
